  ...
  return (
    <div className="w-full flex flex-col bg-white p-6 rounded-lg shadow-lg text-black space-y-4">
      ...
      <DownloadButton
        ...
        outputFormat={outputFormat}
        filename={filename}
        filenameFallback={`helmfile-diagram.${(outputFormat || 'png').toLowerCase()}`}
      />
      ...
      {/* Notation Options */}
      {diagram && <NotationOptions diagramType="helmfile" />}
    </div>
  );
}

export default HelmFileOutput;
